...
#define STRING_CONFIG_H_AUTHOR "(Antu mArk, Geetech pro c, modded as B)" // Who made the changes.
...
#define MACHINE_UUID "578bc441-71f8-44e9-9cbb-7897f20a6402"
...
#define INVERT_Y_DIR true //GALI BUTI CIA
#define INVERT_Z_DIR false

// @section extruder

// For direct drive extruder v9 set to true, for geared extruder set to false.
#define INVERT_E0_DIR true //GALI BUTI CIA
